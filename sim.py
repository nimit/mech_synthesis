...
def simulate_mechanism(A, x0, node_type, n=200):
...
def draw_mechanism(A,x0,fixed_nodes,motor, highlight=100, solve=False, thetas = np.linspace(0,np.pi*2,200), def_alpha = 1.0, h_alfa =1.0, h_c = "#f15a24"):
