...
# PATHS
# =========================
checkpoint_path = "./weights/LATENT_LLAMA_d1536_h32_n6_bs512_lr0.0005_best.pth"
data_dir = "dataset_33mechs"

OUT_DIR = "results_gt_vs_pred_knn_cd_and_dtw_discrete2"
...
# =========================
Z = np.stack(
    [dataset[i]["vae_mu"].cpu().numpy().reshape(-1) for i in range(len(dataset))]
)
...
# d_size_512_h_6 run on 02/17
# === FINAL METRIC SUMMARY ===
# QUERY CD | count=88 | mean=0.063557 | median=0.011517 | success(<0.01)=41
# QUERY DTW | count=88 | mean=0.092921 | median=0.005989 | success(<0.25)=79
# KNN MEAN CD | count=88 | mean=0.050554 | median=0.023892 | success(<0.01)=25
# KNN MEAN DTW | count=88 | mean=0.101704 | median=0.027836 | success(<0.25)=78

# d_size_1536_h_32 run on 02/18
# === FINAL METRIC SUMMARY ===
# QUERY CD | count=96 | mean=0.068028 | median=0.009521 | success(<0.01)=48
# QUERY DTW | count=96 | mean=0.102097 | median=0.006467 | success(<0.25)=84
# KNN MEAN CD | count=96 | mean=0.048965 | median=0.022413 | success(<0.01)=30
# KNN MEAN DTW | count=96 | mean=0.106179 | median=0.026281 | success(<0.25)=85
